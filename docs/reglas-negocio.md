...
### Reglas implementadas en Capa 6A — Cobros
...
La interfaz, integración visual con Turnos, totales y recorrido manual siguen pendientes para etapas posteriores de Capa 6.
