...
export default function TurnoDetailPage() {
  ...
  const solicitarAccion = (nombre, accionApi, dialogo) => dialogo ? setConfirmacion({ nombre, accionApi, ...dialogo }) : ejecutarAccion(nombre, accionApi);
